...
// ─── GoalFormFields ──────────────────────────────────────────────────────────
// Just the fields — no buttons, no outer container.
// Buttons live in a pinned footer outside the scroll zone in GoalsTab.

function GoalFormFields({ form, setForm }) {
...
function GoalsTab({ goals, onUpdate }) {
  ...
  // ── FORM VIEW ──────────────────────────────────────────────────────────────
  // .goal-form-screen fills the full height of .tab-content (height:100%).
  // Fields scroll inside .goal-form-scroll.
  // Buttons live in .goal-form-footer — completely outside the scroll zone,
  // always visible regardless of content height or keyboard state.
  if (view === 'add') {
    return (
      <div className="goal-form-screen">
        <div className="goal-form-scroll">
          <div className="goal-form-heading">New Goal</div>
